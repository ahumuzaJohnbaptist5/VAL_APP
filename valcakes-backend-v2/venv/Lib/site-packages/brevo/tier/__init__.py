...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "CreateTierGroupRequestDowngradeSchedule": ".types",
    "CreateTierGroupRequestDowngradeScheduleDurationModifier": ".types",
    "CreateTierGroupRequestDowngradeScheduleDurationUnit": ".types",
    "CreateTierGroupRequestDowngradeStrategy": ".types",
    "CreateTierGroupRequestMeta": ".types",
    "CreateTierGroupRequestUpgradeSchedule": ".types",
    "CreateTierGroupRequestUpgradeScheduleDurationModifier": ".types",
    "CreateTierGroupRequestUpgradeScheduleDurationUnit": ".types",
